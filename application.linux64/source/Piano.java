...
public void keyPressed()
{
        ...
        if (k != null)
        {
                ...
                out.playNote(0.0f, 1.3f, new SineInstrument(Frequency.ofPitch(blackNotes[k]).asHz()));  
        ...
        else
        {
                ...
                pressedWhite[k] = true;
                out.playNote(0.0f, 1.3f, new SineInstrument(Frequency.ofPitch(whiteNotes[k]).asHz()));  
